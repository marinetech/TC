    ...
    <Container maxWidth="lg">
      ...
      >
        ...
        <Box sx={{ my: 4 }}>
          ...
          <img
            src={marineMetrologyDiagram}
            alt="Technical Committee on Marine Metrology Diagram"
            style={{ maxWidth: '100%', height: 'auto', display: 'block', margin: '0 auto', border: '1px solid #ccc', borderRadius: '4px' }}
          />
